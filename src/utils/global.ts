...
export function removeExtraSpecialCharHyphens(input: string): string {
    console.log(input)
    var fileName = input.replace(/[^a-zA-Z0-9]/g,'-')

    fileName = fileName.replace(/-+/g, '-').trim().toLowerCase(); 
