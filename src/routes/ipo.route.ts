...
import { logoPathLocal } from "../utils/constant";

const multer = require('multer');

const storage = multer.diskStorage({
    destination: (req:any, file:any, cb:any) => {
      cb(null, `${logoPathLocal}`);
    },
...
class ipoRoute implements IRouting {
    ...
    register(app: express.Application) {
      ...
      app.post(`${this.prefix}/add`,middleware.isCookieAuthenticated,upload.single('logo'),(req:Request ,res:Response,next: express.NextFunction)=> {        
      ...
      app.post(`${this.prefix}/deleteSme/`,(req:Request ,res:Response,next: express.NextFunction)=> {
        return IpoController.ipoDelete(req,res,next);
      });

      app.post(`${this.prefix}/active/:id`,middleware.isCookieAuthenticated,(req:Request ,res:Response,next: express.NextFunction)=> {
      ...
      app.get(`${this.prefix}/getDashboard`,middleware.isCookieAuthenticated,(req:Request ,res:Response,next: express.NextFunction)=> {
        return IpoController.getDashboard(req,res,next);
      });
    }
}
